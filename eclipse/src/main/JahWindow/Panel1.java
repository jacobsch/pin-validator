...
public class Panel1 extends JPanel {
	...
	private JPanel container; // Adding the container locally so it does not interfere with the other panel
								// files
	private JButton toLogin; // Adding the container locally so it does not interfere with the other panel
								// files
	private JButton btnSubmit; // Adding the container locally so it does not interfere with the other panel
								// files
	...
	JTextField txtAge; // Init this textarea to the program
	...
	JComboBox<Object> comboxGender; // Init this combobox to the program
	...
	public void initComponents() {
		// This method will give values to all of the textfields, combobox, labels etc
		...
		txtAge = new JTextField(5); // Giving value to our text area
		...
		comboxGender = new JComboBox<Object>(comboxGenderItems); // Giving value to our combobox (the String array
																	// previously created (line70))
		...
		btnSubmit.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (txtFirst.getText().equals(empty) || txtLast.getText().equals(empty)
						|| txtEmail.getText().equals(empty) || txtPhone.getText().equals(empty)
						|| txtAddress.getText().equals(empty) || pwdPin.getText().equals(empty)
	...
	public void submitToJSON(String fileName) throws Exception {
		...
		information.put("sex", String.valueOf(comboxGender.getSelectedItem())); // Aquiring the String value of the
																				// combobox, rather than seeing "2" you
																				// see "Vatougios"
		// Writing the file to the /accounts path with the fileName created earlier
		Files.write(Paths.get("src/accounts/" + fileName), information.toJSONString().getBytes());
